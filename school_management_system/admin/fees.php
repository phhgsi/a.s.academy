<?php
// Redirect to new separated fees list page
            ...
            <div class="content-wrapper fade-in">
                <div class="page-header d-flex justify-between align-center">
                    ...
                    <div class="d-flex gap-1">
                        ...
                        <a href="?action=structure" class="btn btn-secondary">📊 Fee Structure</a>
                    </div>
                </div>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($fee_payments as $payment): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="receipt.php?id=<?php echo $payment['id']; ?>" class="btn btn-outline" style="padding: 0.5rem;" target="_blank">🧾</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <?php foreach ($fee_structure as $fee): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="?action=edit_structure&id=<?php echo $fee['id']; ?>" class="btn btn-outline" style="padding: 0.5rem;">✏️</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
